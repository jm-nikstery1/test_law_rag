...
def main():
    ...
    try:
        ...
        for item in tqdm(eval_dataset, desc="Ragas 평가 중 (항목별)"):
            # Ragas는 데이터셋 객체를 기대하므로 각 항목을 데이터셋으로 감쌉니다.
        ...
        if all_scores:
            ...
            output_filename = f"ragas_hybrid_evaluation_result_{OLLAMA_MODEL}_{len(eval_df)}q_sequential_test_50.csv"
